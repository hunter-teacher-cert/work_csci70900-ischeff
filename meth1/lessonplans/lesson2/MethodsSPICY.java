...
public class MethodsSPICY{
  ...
  //create a main method to print out today's date
    //main should invoke your date method and ALSO the other methods
      //the other methods should pass the user data to date to print the result!
}
